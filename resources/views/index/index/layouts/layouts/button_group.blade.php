<div class="main-section-button-group">
    <div class="main-section-shift-button-container">
        <button class="main-section-shift-button pre"><img class="main-section-shift-button-image" src="/assets/index/images/list-page-pre.png" alt="上一页"></button>
    </div>
    ...
    <div class="main-section-shift-button-container">
        <button class="main-section-shift-button next"><img class="main-section-shift-button-image" src="/assets/index/images/list-page-next.png" alt="下一页"></button>
    </div>
</div>
