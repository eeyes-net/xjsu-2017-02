...
@section('content')
    ...
    <section class="content">
        ...
        <!-- Main row -->
        <div class="row">
            <form action="{{ action('Admin\OptionController@update', ['name' => 'presidium']) }}" method="POST">
                {{ csrf_field() }}
                {{ method_field('PATCH') }}
                        ...
                        <div class="box-body">
                                ...
                                @foreach($value as $i => $item)
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <input class="form-control" name="value[{{ $i }}][introduction]" value="{{ $item['introduction'] }}">
                                            </div>
                                            <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <input class="form-control" name="value[{{ $i }}][introduction]">
                                    </div>
                                    <div class="col-lg-4">
